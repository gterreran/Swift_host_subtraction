...
sn_reg='Region file indicating the coordinates of the SN. The format is the default region file from ds9 (eg. \'fk5;circle(00:00:00.000,+00:00:00.000,3")\'). The default radius is 3", but the photometry will be also compared with a 5" aperture. If this argument is not provided, the script will assume that a file "sn.reg" exist.'
